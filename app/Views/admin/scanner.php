...
<head>
  ...
  <!-- scanner -->
  <script src="<?= base_url('/'); ?>/scanner/vendor/modernizr/modernizr.js"></script>
  <script src="<?= base_url('/'); ?>/scanner/vendor/vue/vue.min.js"></script>
</head>
<body>
  ...
  <div id="app" class="row box">
    <div class="col-md-4 col-md-offset-4 sidebar">
      ...
      <!-- form scan -->
      <form action="<?= base_url('/dashboard/result-scanner'); ?>" method="POST" id="myForm">
  ...
  <!-- scanner -->
  <script src="<?= base_url('/'); ?>/scanner/js/app.js"></script>
  <script src="<?= base_url('/'); ?>/scanner/vendor/instascan/instascan.min.js"></script>
  <script src="<?= base_url('/'); ?>/scanner/js/scanner.js"></script>
</body>