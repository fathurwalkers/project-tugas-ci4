...
<div class="card">
    <div class="card-header">
        ...
        <a href="<?php echo base_url('dashboard/daftar-produk') ?>"
            class="float-right btn btn-primary mt-1">Kembali</a>
    </div>
    <div class="card-body">

        <form
            action="<?= base_url('/dashboard/edit-produk') ?>/<?php echo $produk['produk_id']; ?>"
            method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="form-group">
                <label for="nama_produk">Masukkan Nama Produk</label>
                <input type="text" class="form-control" id="nama_produk" aria-describedby="emailHelp"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="harga_produk" aria-describedby="emailHelp"
